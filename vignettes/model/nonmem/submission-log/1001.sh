...
/cluster-data/user-homes/matthews/.local/bin/nmm-x86_64-unknown-linux-gnu/nmm -c /cluster-data/user-homes/matthews/Packages/slurmtools/vignettes/model/nonmem/1001.toml run
